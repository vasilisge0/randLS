...
magma_int_t geqrf3_gpu(magma_int_t m, magma_int_t n, magmaDouble_ptr dA,
                       magma_int_t ldda, double* tau, magmaDouble_ptr dT,
                       magma_int_t* info)
{
    auto exit_code = magma_dgeqrf3_gpu(m, n, dA, ldda, tau, dT, info);
    return exit_code;
}

magma_int_t geqrf3_gpu(magma_int_t m, magma_int_t n, magmaFloat_ptr dA,
                       magma_int_t ldda, float* tau, magmaFloat_ptr dT,
                       magma_int_t* info)
{
    auto exit_code = magma_sgeqrf3_gpu(m, n, dA, ldda, tau, dT, info);
    return exit_code;
}
