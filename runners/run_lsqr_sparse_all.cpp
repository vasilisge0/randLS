...
template<typename vtype_precond_apply, typename vtype_precond_internal, typename vtype_solver_internal, typename vtype_solver>
void run_reg_lsqr_instance(double tol, int maxiter, int miniter, magma_int_t restarts, double sampling_coeff, std::string& matrix, std::string& filename_relres,
...
void run_lsqr_for_precisions(solver_config_t& parameters)
{
...
void run_reg_lsqr_for_precisions(solver_config_t& parameters)
{
...
int main(int argc, char* argv[])
{
    ...
    //            parameters.filename_xnoisy = "../lsqr_data/" + matrix + "_xnoisyreg.mtx";
    //            run_reg_lsqr_for_precisions(parameters);
    //        }
    //    }
    //}
    ...
    //            parameters.filename_rhs = "../lsqr_data/" + matrix + "_rhs.mtx";
    //            parameters.filename_xtrue = "../lsqr_data/" + matrix + "_xtrue.mtx";
    //            run_lsqr_for_precisions(parameters);
    //        }
    //    }
    //}
