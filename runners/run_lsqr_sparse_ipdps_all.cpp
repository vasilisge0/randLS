...
int main(int argc, char* argv[]) {
    ...
    vector<string> matrix_names = {"sprand"};
   ...
   s//td::shared_ptr<rls::preconditioner::Config> precond_config;
   u//sing precond_config_type =
    //   rls::preconditioner::SketchQrConfig
    //       <double, double, double, magma_int_t>;
   p//recond_config = rls::share(precond_config_type::create(sampling_coeff));
   p//recond = rls::preconditioner::SketchQr<rls::CUDA, double, double, double, magma_int_t>::create(mtx, sketch, precond_config);
