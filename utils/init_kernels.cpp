...
// // }
// // 
// template void finalize(void* mtx, void* dmtx, void* init_sol, void* sol,
//                        void* rhs, detail::magma_info& magma_config);
// // 
// // 
// // template <typename value_type>
...
//                                 // *init_sol, *sol, *rhs);
//                                 // cudaDeviceSynchronize();
//     // std::cout << "before generating sketch\n";
//     Generates sketch matrix.
//     // value_type* sketch_mtx = nullptr;
//     // index_type sampled_rows = (index_type)(sampling_coeff * num_cols);
//     // memory::malloc(&sketch_mtx, sampled_rows * num_rows);
...
//         // auto status = curandGenerateNormalDouble(
//             // magma_config.rand_generator, (double*)sketch_mtx, sampled_rows * num_rows, 0, 1);
//     // }
//     // else if (std::is_same<value_type, float>::value) {
//         // auto status = curandGenerateNormal(
//             // magma_config.rand_generator, (float*)sketch_mtx, sampled_rows * num_rows, 0, 1);
//     // }
//     // cudaDeviceSynchronize();
// // 
//     rls::io::write_mtx((char*)file_out.c_str(), sampled_rows, num_rows, sketch_mtx,
//         num_rows, magma_config.queue);
// // 
//     Generates preconditioner.
//     // value_type* dt = nullptr;
//     // memory::malloc(&dt, sampled_rows * num_cols);
...
//     // std::string filename_mtx, std::string filename_rhs, magma_int_t* num_rows, magma_int_t* num_cols,
//     // float** mtx, float** d_mtx, float** init_sol, float** sol, float** rhs,
//     // double sampling_coeff, magma_int_t* sampled_rows_io, float** precond_mtx,
//     // detail::magma_info& magma_config, double* t_precond);
// // 
...
//                             //  detail::magma_info& magma_config, double* t_precond)
// // {
//     // detail::use_tf32_math_operations(magma_config);
//     // index_type num_rows = 0;
//     // index_type num_cols = 0;
//     // std::cout << "filename_mtx: " << filename_mtx << '\n';
//     // io::read_mtx_size((char*)filename_mtx.c_str(), &num_rows, &num_cols);
